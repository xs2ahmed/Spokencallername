...
public class AppRater 
{
    ...
    {    	
    	String APP_TITLE = mContext.getString(R.string.app_name);
    	final String APP_PNAME = mContext.getPackageName();
    	
    	// Just being cautious as this code runs only after certain days and I havent tested it much
